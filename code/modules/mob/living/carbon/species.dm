...
/datum/species/diona
	...
	flags = NO_BREATHE | REQUIRE_LIGHT | NO_SCAN | IS_PLANT | RAD_ABSORB | NO_PAIN | HYPOTHERMIA_IMMUNE
...
/datum/species/mushroom
	...
	flags = NO_BREATHE | IS_PLANT | REQUIRE_DARK | IS_SPECIES_MUTE
